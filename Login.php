...
<div class="container py-3 mt-4 col-sm-8  d-flex justify-content-center m-auto" style="background: aliceblue;">
    ...
    <form action="code/LoginCode" method="post">
        <div class="container col-md-8  d-flex justify-content-center m-auto row py-5">
            <h1 class="text-center paraPannel">Login</h1>
            ...
            <div class="mb-3 " style="height: 80px;">
                <?php
                                if(isset($_SESSION['msg_l']) && $_SESSION['msg_l']!='')
                                {
                                    ?>
            ...
            <div class="mb-3 ">
                ...
                <input type="text" name="userid" class="form-control py-2 mt-2">
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3 d-flex justify-content-center ">
                <button name="loginBtn" class="btn btn-secondary px-5">Login</button>
            </div>
        </div>
        <div class="mb-3 d-flex justify-content-around ">
            <a href="Register" class="text-decoration-none">Don't Have an Account &rarr;</a>
            <a href="Forget" class="text-decoration-none">&larr; Forget Password </a>
        </div>
    </form>
</div>
<?php
